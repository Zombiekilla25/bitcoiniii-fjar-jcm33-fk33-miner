"""BitcoinIII (BTC3) SHA3-256T pool bridge for the SQRL FK33 FPGA miner."""
...
WORKER = os.environ.get("BTC3_WORKER", "fk33").strip()
SERIAL = os.environ.get("BTC3_SERIAL", os.environ.get("BC3_SERIAL", "UNKNOWN"))
HW_HOST = os.environ.get("BTC3_HW_HOST", "127.0.0.1")
HW_PORT = int(os.environ.get("BTC3_HW_PORT", "22000"))
...
def validate_configuration():
    ...
    if not 1 <= HW_PORT <= 65535:
        raise ValueError("BTC3_HW_PORT must be between 1 and 65535")
