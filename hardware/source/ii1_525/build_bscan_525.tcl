...
create_project -force fk33_fjar_bscan_525 $build_dir -part $part
...
puts "============================================================"
puts "BEGIN FK33 FJAR II1 BSCAN 525 MHZ SYNTHESIS"
puts "============================================================"
...
write_checkpoint -force \
    [file join $output_dir fk33_fjar_bscan_525_routed.dcp]
...
set output_bit [file join $output_dir fk33_fjar_bscan_525.bit]
write_bitstream -force $output_bit

puts "============================================================"
puts "FK33 FJAR II1 BSCAN 525 MHZ FULL BUILD COMPLETE"
