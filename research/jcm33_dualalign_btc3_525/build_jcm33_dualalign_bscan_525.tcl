...
set top miner_top_ii1_bscan_525

file mkdir $build_dir
file mkdir $output_dir
set_param general.maxThreads 8

create_project -force jcm33_dualalign_bscan_525 $build_dir -part $part
...
add_files [list \
    ...
    [file join $script_dir miner_top_ii1_bscan_525.sv] \
]

set_property file_type SystemVerilog [get_files *.sv]
add_files -fileset constrs_1 [file join $script_dir fk33_bscan_525.xdc]
set_property top $top [current_fileset]
update_compile_order -fileset sources_1

puts "============================================================"
puts "BEGIN JCM33 DUAL-ALIGN II1 BSCAN 525 MHZ SYNTHESIS"
puts "============================================================"
...
write_checkpoint -force \
    [file join $output_dir jcm33_dualalign_bscan_525_routed.dcp]
...
set output_bit [file join $output_dir jcm33_dualalign_bscan_525.bit]
write_bitstream -force $output_bit

puts "============================================================"
puts "JCM33 DUAL-ALIGN II1 BSCAN 525 MHZ FULL BUILD COMPLETE"
